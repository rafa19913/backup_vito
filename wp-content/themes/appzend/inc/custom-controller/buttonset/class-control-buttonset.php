<?php
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'AppZend_Buttonset' ) ) :
	/**
	 ...
	 * Buttonset control
	 */
	class AppZend_Buttonset extends WP_Customize_Control {
		/**
		 * The control type.
		 *
		 * @access public
	...
	$wp_customize->register_control_type('AppZend_Buttonset');
endif;