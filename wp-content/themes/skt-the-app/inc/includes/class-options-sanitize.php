...
function of_recognized_background_repeat() {
	...
	$default = array(
		'no-repeat' => __( 'No Repeat', 'the-app' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'the-app' ),
		'repeat-y'  => __( 'Repeat Vertically', 'the-app' ),
		'repeat'    => __( 'Repeat All', 'the-app' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'the-app' ),
		'top center'    => __( 'Top Center', 'the-app' ),
		'top right'     => __( 'Top Right', 'the-app' ),
		'center left'   => __( 'Middle Left', 'the-app' ),
		'center center' => __( 'Middle Center', 'the-app' ),
		'center right'  => __( 'Middle Right', 'the-app' ),
		'bottom left'   => __( 'Bottom Left', 'the-app' ),
		'bottom center' => __( 'Bottom Center', 'the-app' ),
		'bottom right'  => __( 'Bottom Right', 'the-app')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'the-app' ),
		'fixed'  => __( 'Fixed in Place', 'the-app')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'the-app' ),
		'italic'      => __( 'Italic', 'the-app' ),
		'bold'        => __( 'Bold', 'the-app' ),
		'bold italic' => __( 'Bold Italic', 'the-app' )
		);
