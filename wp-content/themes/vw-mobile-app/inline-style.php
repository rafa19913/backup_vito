<?php
	...
	if($vw_mobile_app_first_color != false){
		$vw_mobile_app_custom_css .=' .nav-previous a:hover, .nav-next a:hover, .woocommerce #respond input#submit:hover, .woocommerce a.button:hover, .woocommerce button.button:hover, .woocommerce input.button:hover, .woocommerce #respond input#submit.alt:hover, .woocommerce a.button.alt:hover, .woocommerce button.button.alt:hover, .woocommerce input.button.alt:hover{';
			$vw_mobile_app_custom_css .='background-color: '.esc_attr($vw_mobile_app_first_color).'!important;';
		$vw_mobile_app_custom_css .='}';
	}
	if($vw_mobile_app_first_color != false){
		$vw_mobile_app_custom_css .='a, #footer h3, .post-main-box:hover h3 a, .post-navigation a:hover .post-title, .post-navigation a:focus .post-title, .entry-content a, .post-main-box:hover h2 a, .post-main-box:hover .entry-date a, .post-main-box:hover .entry-author a, .single-post .post-info:hover .entry-date a, .single-post .post-info:hover .entry-author a, #footer li a:hover, #sidebar li a:hover, .box-content h1 a:hover, .catgory-box:hover h3 a, #footer .wp-block-search .wp-block-search__label{';
	...
	if($vw_mobile_app_second_color != false){
		$vw_mobile_app_custom_css .='.main-navigation ul.sub-menu a:hover, .page-template-custom-home-page .main-navigation a:hover, .entry-content a, .sidebar .textwidget p a, .textwidget p a, #comments p a, .slider .inner_carousel p a, #footer .custom-social-icons i, #sidebar .custom-social-icons i, .page-template-custom-home-page .logo .site-title a:hover, .entry-summary a{';
	...
	/*------------- Banner Content Padding Settings ------------------*/

	$vw_mobile_app_slider_content_padding_top_bottom = get_theme_mod('vw_mobile_app_slider_content_padding_top_bottom');
	$vw_mobile_app_slider_content_padding_left_right = get_theme_mod('vw_mobile_app_slider_content_padding_left_right');
	if($vw_mobile_app_slider_content_padding_top_bottom != false || $vw_mobile_app_slider_content_padding_left_right != false){
		$vw_mobile_app_custom_css .='#banner .box-content{';
			$vw_mobile_app_custom_css .='top: '.esc_attr($vw_mobile_app_slider_content_padding_top_bottom).'; bottom: '.esc_attr($vw_mobile_app_slider_content_padding_top_bottom).';left: '.esc_attr($vw_mobile_app_slider_content_padding_left_right).';right: '.esc_attr($vw_mobile_app_slider_content_padding_left_right).';';
		$vw_mobile_app_custom_css .='}';
	}
	...
	$vw_mobile_app_navigation_menu_font_size = get_theme_mod('vw_mobile_app_navigation_menu_font_size');
	if($vw_mobile_app_navigation_menu_font_size != false){
		$vw_mobile_app_custom_css .='.main-navigation a{';
			$vw_mobile_app_custom_css .='font-size: '.esc_attr($vw_mobile_app_navigation_menu_font_size).';';
		$vw_mobile_app_custom_css .='}';
	}
	...
	$vw_mobile_app_featured_image_border_radius = get_theme_mod('vw_mobile_app_featured_image_border_radius', 0);
	if($vw_mobile_app_featured_image_border_radius != false){
		$vw_mobile_app_custom_css .='.box-image img, .feature-box img{';
			$vw_mobile_app_custom_css .='border-radius: '.esc_attr($vw_mobile_app_featured_image_border_radius).'px;';
		$vw_mobile_app_custom_css .='}';
	}

	$vw_mobile_app_featured_image_box_shadow = get_theme_mod('vw_mobile_app_featured_image_box_shadow',0);
	if($vw_mobile_app_featured_image_box_shadow != false){
		$vw_mobile_app_custom_css .='.box-image img, .feature-box img, #content-vw img{';
			$vw_mobile_app_custom_css .='box-shadow: '.esc_attr($vw_mobile_app_featured_image_box_shadow).'px '.esc_attr($vw_mobile_app_featured_image_box_shadow).'px '.esc_attr($vw_mobile_app_featured_image_box_shadow).'px #cccccc;';
		$vw_mobile_app_custom_css .='}';
	}
	...
	$vw_mobile_app_footer_background_color = get_theme_mod('vw_mobile_app_footer_background_color');
	if($vw_mobile_app_footer_background_color != false){
		$vw_mobile_app_custom_css .='#footer{';
			$vw_mobile_app_custom_css .='background-color: '.esc_attr($vw_mobile_app_footer_background_color).';';
		$vw_mobile_app_custom_css .='}';
	}

	$vw_mobile_app_copyright_font_size = get_theme_mod('vw_mobile_app_copyright_font_size');
	if($vw_mobile_app_copyright_font_size != false){
		$vw_mobile_app_custom_css .='.copyright p{';
			$vw_mobile_app_custom_css .='font-size: '.esc_attr($vw_mobile_app_copyright_font_size).';';
		$vw_mobile_app_custom_css .='}';
	}
	...
	$vw_mobile_app_copyright_alignment = get_theme_mod('vw_mobile_app_copyright_alignment');
	if($vw_mobile_app_copyright_alignment != false){
		$vw_mobile_app_custom_css .='.copyright p{';
			$vw_mobile_app_custom_css .='text-align: '.esc_attr($vw_mobile_app_copyright_alignment).';';
		$vw_mobile_app_custom_css .='}';
	}
	...
	$vw_mobile_app_products_border_radius = get_theme_mod('vw_mobile_app_products_border_radius', 0);
	...
	$vw_mobile_app_products_button_border_radius = get_theme_mod('vw_mobile_app_products_button_border_radius', 0);
	if($vw_mobile_app_products_button_border_radius != false){
		$vw_mobile_app_custom_css .='.woocommerce ul.products li.product .button, a.checkout-button.button.alt.wc-forward,.woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt{';
			$vw_mobile_app_custom_css .='border-radius: '.esc_attr($vw_mobile_app_products_button_border_radius).'px;';
		$vw_mobile_app_custom_css .='}';
	}

	$vw_mobile_app_woocommerce_sale_position = get_theme_mod( 'vw_mobile_app_woocommerce_sale_position','right');
    if($vw_mobile_app_woocommerce_sale_position == 'left'){
		$vw_mobile_app_custom_css .='.woocommerce ul.products li.product .onsale{';
			$vw_mobile_app_custom_css .='left: -10px; right: auto;';
		$vw_mobile_app_custom_css .='}';
	}else if($vw_mobile_app_woocommerce_sale_position == 'right'){
		$vw_mobile_app_custom_css .='.woocommerce ul.products li.product .onsale{';
			$vw_mobile_app_custom_css .='left: auto; right: 0;';
		$vw_mobile_app_custom_css .='}';
	}

	$vw_mobile_app_woocommerce_sale_font_size = get_theme_mod('vw_mobile_app_woocommerce_sale_font_size');
	if($vw_mobile_app_woocommerce_sale_font_size != false){
		$vw_mobile_app_custom_css .='.woocommerce span.onsale{';
			$vw_mobile_app_custom_css .='font-size: '.esc_attr($vw_mobile_app_woocommerce_sale_font_size).';';
		$vw_mobile_app_custom_css .='}';
	}

	$vw_mobile_app_woocommerce_sale_border_radius = get_theme_mod('vw_mobile_app_woocommerce_sale_border_radius', 100);
	if($vw_mobile_app_woocommerce_sale_border_radius != false){
		$vw_mobile_app_custom_css .='.woocommerce span.onsale{';
			$vw_mobile_app_custom_css .='border-radius: '.esc_attr($vw_mobile_app_woocommerce_sale_border_radius).'px;';
		$vw_mobile_app_custom_css .='}';
	}
	...
	$vw_mobile_app_site_title_font_size = get_theme_mod('vw_mobile_app_site_title_font_size');
	if($vw_mobile_app_site_title_font_size != false){
		$vw_mobile_app_custom_css .='.logo h1 a, .logo p.site-title a{';
			$vw_mobile_app_custom_css .='font-size: '.esc_attr($vw_mobile_app_site_title_font_size).';';
		$vw_mobile_app_custom_css .='}';
	}

	// Site tagline Font Size
	$vw_mobile_app_site_tagline_font_size = get_theme_mod('vw_mobile_app_site_tagline_font_size');
	if($vw_mobile_app_site_tagline_font_size != false){
		$vw_mobile_app_custom_css .='.logo p.site-description{';
			$vw_mobile_app_custom_css .='font-size: '.esc_attr($vw_mobile_app_site_tagline_font_size).';';
		$vw_mobile_app_custom_css .='}';
	}
