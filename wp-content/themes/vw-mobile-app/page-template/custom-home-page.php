          ...
          while ( $query->have_posts() ) : $query->the_post(); ?>
            <div class="main-box">
              ...
              <div class="box-content">
                <h1 class="wow wobble" data-wow-duration="2s"><a href="<?php echo esc_url( get_permalink() );?>"><?php the_title(); ?></a></h1><span class="screen-reader-text"><?php the_title(); ?></span>
                <p class="wow lightSpeedIn" data-wow-duration="2s"><?php $excerpt = get_the_excerpt(); echo esc_html( vw_mobile_app_string_limit_words( $excerpt, esc_attr(get_theme_mod('vw_mobile_app_slider_excerpt_number','30')))); ?></p>
