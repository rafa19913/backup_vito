...
function vw_mobile_app_scripts() {
	...
	wp_enqueue_script( 'vw-mobile-app-jquery-wow', esc_url(get_template_directory_uri()) . '/js/wow.js', array('jquery') );
	wp_enqueue_style( 'vw-mobile-app-animate-css', esc_url(get_template_directory_uri()).'/css/animate.css' );
...
function vw_mobile_app_logo_title_hide_show(){
	if(get_theme_mod('vw_mobile_app_logo_title_hide_show') == '1' ) {
		return true;
	}
	return false;
}

function vw_mobile_app_tagline_hide_show(){
	if(get_theme_mod('vw_mobile_app_tagline_hide_show') == '1' ) {
		return true;
	}
	return false;
}
