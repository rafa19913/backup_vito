...
= 0.4.5 =
  ...
  -- Add show / hide search option in customizer.
  -- Resolved the css customization.
  -- Updated language folder.
...
= 0.5.6 =
  ...
  -- Added banner height option in customizer. 
  -- Updated language folder.
...
= 0.6 =
  -- Resolved errors.
  -- Done Social icons widget css customization.
...
= 0.6.9 =
  ...
  -- Resolved error of Sticky header & scroll to top show/ hide does not work in responsive media settings.
  -- Resolved error of Scroll appears on the top of the page & scroll appears first after refreshing page.

= 0.7 =
  -- Done banner & about sec css of block pattern in tab media.
  -- Done css of banner search in mobile media.
...
= 0.7.4 =
  ...
  -- Check footer widget padding afer widget.

= 0.7.5 =  
  -- Done css of toggle button in responsive. 
  -- Checked submenu.
  -- Add target="_blank" in get started & copyright link.
  -- Removed border-bottom from a:focus.
  -- Added opacity to hr class.
...
= 0.7.7 =
  -- Removed block pattern tab from getstarted
...
= 0.8.2 =
  -- Added banner content padding top bottom option in customizer.
  -- Added footer background color option in customizer. 
  -- Added banner content padding left right option in customizer.
  -- Updated language folder.
...
VW Mobile App WordPress Theme, Copyright 2018 VWthemes
VW Mobile App is distributed under the terms of the GNU GPL.
...
* Stocksnap Images, 
  ...
  Slider Image, Copyright Diego
  License: CC0 1.0 Universal (CC0 1.0)
  Source: https://stocksnap.io/photo/1WKDTOX1FA

== Theme Documentation ==
Documentation : https://www.vwthemesdemo.com/docs/free-vw-mobile-app/